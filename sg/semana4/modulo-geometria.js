...
function Esfera(radio){
    ...
    this.getPosicion=function(u,v){
        sin_u = Math.sin(2*Math.PI*u)
        cos_u = Math.cos(2*Math.PI*u)
        sin_v = Math.sin(2*Math.PI*v)
        cos_v = Math.cos(2*Math.PI*v)
        var x=cos_v*sin_u*radio;
        var y=cos_v*cos_u*radio;
        var z=sin_v*radio;
        return [x,y,z];
    }
...
function TuboSenoidal(amplitud,lambda,radio,altura){
    ...
    this.getPosicion=function(u,v){
        ...
        var x=Math.sin(2*Math.PI*u)*(radio+amplitud*Math.cos(2*Math.PI*(v/lambda)));
        var z=Math.cos(2*Math.PI*u)*(radio+amplitud*Math.cos(2*Math.PI*(v/lambda)));
        return [x,altura*v,z];
    }

    this.getNormal=function(u,v){
        return [Math.sin(2*Math.PI*u),0,Math.cos(2*Math.PI*u)];
    }
